...
const styles = StyleSheet.create({
  container: { flex: 1, alignItems: 'center', paddingTop: 40, backgroundColor: '#f1e3d8' },
  center: { justifyContent: 'center', alignItems: 'center' },
  avatar: { fontSize: 64, marginBottom: 12 },
  inputHeaderLabel: { fontSize: 11, fontWeight: 'bold', color: '#72523c', alignSelf: 'flex-start', marginLeft: '10%', marginBottom: 4 },
