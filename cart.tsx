...
export default function CartApp() {
  ...
  if (loading) {
    return (
      <View style={[styles.container, styles.center, { backgroundColor: '#f1e3d8' }]}>
  ...
  if (currentView === 'OrderSummary') {
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity
          style={[styles.button, { backgroundColor: '#cb7919', width: '90%', marginBottom: 10 }]}
        ...
        <TouchableOpacity
          style={[styles.button, { backgroundColor: '#a8a8a8', width: '90%', marginBottom: 20 }]}
...
const styles = StyleSheet.create({
  container: { flex: 1, alignItems: 'center', backgroundColor: '#f1e3d8' },
  ...
  cartItem: { flexDirection: 'row', backgroundColor: '#ffffff', padding: 12, borderRadius: 10, marginBottom: 10, alignItems: 'center', elevation: 1 },
  cartThumbnail: { width: 50, height: 50, borderRadius: 6, marginRight: 12 },
  itemName: { fontSize: 16, fontWeight: '600', color: '#3E1F00' },
  itemPrice: { color: '#cb7919', marginTop: 2 },
  removeText: { color: '#d81414', fontWeight: '600' },
  ...
  totalPrice: { fontSize: 18, fontWeight: 'bold', color: '#cb7919' },
  summaryRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: '#F5E6D3' },
  summaryText: { fontSize: 16, color: '#72523c' },
  instructionContainer: { width: '90%', marginBottom: 15 },
  instructionLabel: { fontSize: 11, fontWeight: 'bold', color: '#72523c', marginBottom: 4 },
  inputField: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#72523c', padding: 10, borderRadius: 5, color: '#3E1F00', marginBottom: 8 },
  ...
  displayNoteBox: { backgroundColor: '#72523c', padding: 12, borderRadius: 5, borderWidth: 1, borderColor: '#d0ebd9', marginBottom: 5 },
  ...
  timestampText: { fontSize: 11, color: '#72523c' },
  ...
  retryButtonText: { color: '#72523c', fontWeight: 'bold' }
});